      ...
      <div className="w-full max-w-md bg-surface-container-lowest rounded-xl p-8 tonal-shift-bottom border border-border">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <button 
            type="submit" 
            disabled={isLoading}
            className="w-full kinetic-authority-gradient text-white py-3 rounded-md font-bold tracking-wide uppercase hover:opacity-90 transition-opacity disabled:opacity-50"
          >
